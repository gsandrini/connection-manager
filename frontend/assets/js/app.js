  ...
  return {
    ...
    init() {
      ...
      try {
        ...
        console.error('SetLanguage init error:', e);
      }
    },
     ...
     */
    deleteAll() {
      if (this.connections.length > 0) this.showConfirmDeleteAll = true;
    },
    confirmDeleteAll() {
      this.connections = [];
      this.saveConnections();
     ...
     */
    deleteSelected() {
      if (this.selectedConn) this.showConfirmDelete = true;
    },
    confirmDelete() {
